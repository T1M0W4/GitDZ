if __name__ == "__main__": 
    from data import newEmployee
    from data import getEmployeeId
    from data import fireEmployee
    from data import getEmployeeRecord
    from data import getFiredEmployees
    from data import getSalaryStats
